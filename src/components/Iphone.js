...
import att from '../images/watch/att.jpeg'
import sprint from '../images/watch/sprint.jpeg'
import tmobile from '../images/watch/tmobile.jpeg'
          ...
          <div className='product-container flex' style={{width: '80vw'}}>
              ...
              <div className='product-images-container flex column center'>
                  ...
                  <div className='offers-container'>
                    ...
                    <div className='offer-container'>
                      ...
                      <div className='offer-text'>Get 3 months of Apple Fitness+ with an Apple Watch**</div>
                    </div>
                    <div className='offer-container'>
            ...
            <div className='right-container'> 
              ...
              <div className='types-container def-font'>
                ...
                <div className='networks-container' style={{marginTop:'0.8em'}}>
                    <div className='def-font carriers-text'>Supported Carriers</div>
                    <div className='flex'>
                      <img className='network-image' src={att}/>
                      <img className='network-image' src={verizon}/>
